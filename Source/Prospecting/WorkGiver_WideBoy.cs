...
namespace Prospecting
{
	...
	public class WorkGiver_WideBoy : WorkGiver_DeepDrill
	{
		...
		public override ThingRequest PotentialWorkThingRequest
		{
			get
			{
				return ThingRequest.ForDef(this.wideBoyDef);
			}
		}
		...
		{
			return pawn.Map.listerBuildings.AllBuildingsColonistOfDef(this.wideBoyDef).Cast<Thing>();
		}
		...
		public override bool ShouldSkip(Pawn pawn, bool forced = false)
		{
			...
			for (int i = 0; i < allBuildingsColonist.Count; i++)
			{
				...
				if (building.def == this.wideBoyDef)
				{
		...
		public override bool HasJobOnThing(Pawn pawn, Thing t, bool forced = false)
		{
			...
			if (compDeepDrill != null)
			{
				...
				bool baseRock = false;
				if (((building != null) ? building.Map : null) != null)
				{
					baseRock = (DeepDrillUtility.GetBaseResource(building.Map, building.TrueCenter().ToIntVec3()) != null);
				}
				CompWideBoy compWideBoy = building.TryGetComp<CompWideBoy>();
				if (compWideBoy != null)
				{
			...
			return (powerComp == null || powerComp.PowerOn) && building.Map.designationManager.DesignationOn(building, DesignationDefOf.Uninstall) == null && !building.IsBurning();
		}
